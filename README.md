...
---
## Test and support for Flywoo F405 20A AIO
You can purchase from here (https://flywoo.net/products/goku-gn405s-20a-aio-mpu6000-25-5-x-25-5)

## Simple setup
```bash
# Make sure you install dependencies for compiling
cd PX4-Autopilot/Tools/setup/
bash ubuntu.sh

# Once completed, make the omnibus (mapping of gpio matches to flywoo F405)
